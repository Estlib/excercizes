...
namespace METHODS1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<string> movies = GetMovies(); //meetodiga küsime filme
        ...
        private static string FindFilms(List<string> movies)
        {
            ...
            foreach (var movie in movies)
            {
                ...
                if (movie == "Kratt")
                {
                    foundmovies += "Vaata et tehisplära ajama ei hakka...\n"; 
                }
            }
            return foundmovies;
        }

        private static void DoesFavouriteMovieExist(string? lemmikfilm, List<string> movies)
        {
